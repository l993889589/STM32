/**
 * @file bsp_dwt.c
 * @brief Cortex-M DWT cycle counter initialization and busy-wait delays.
 */
...
*********************************************************************************************************
*/
/** @brief Busy-wait for the requested number of microseconds using DWT. */
...
/** @brief Busy-wait for an exact number of DWT core clock cycles. */
