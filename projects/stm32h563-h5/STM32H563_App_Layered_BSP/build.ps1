...
$uvProject = Join-Path $projectRoot "MDK-ARM\stm32h563_app_modbus.uvprojx"
$outputDirectory = Join-Path $projectRoot "MDK-ARM\stm32h563_app_modbus"
$buildLog = Join-Path $projectRoot "MDK-ARM\build_stm32h563_app_modbus.log"
