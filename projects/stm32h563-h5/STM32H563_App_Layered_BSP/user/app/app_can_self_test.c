                                 ...
                                 bsp_status_t status)
{
    ...
    board_fdcan_role_t target = g_can_self_test.snapshot.fault_target == 1U ?
                                BOARD_FDCAN_FIELD_1 : BOARD_FDCAN_FIELD_2;
    board_fdcan_role_t peer = target == BOARD_FDCAN_FIELD_1 ?
...
{
    board_fdcan_role_t target;
    board_fdcan_role_t peer;
    uint32_t observed_bus_off;
