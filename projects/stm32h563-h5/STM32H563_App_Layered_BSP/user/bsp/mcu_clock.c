...
static void mcu_clock_capture_snapshot(void);
...
static bool mcu_clock_config_is_valid(const bsp_clock_config_t *config)
{
...
{
    if(!mcu_clock_config_is_valid(config))
    {
