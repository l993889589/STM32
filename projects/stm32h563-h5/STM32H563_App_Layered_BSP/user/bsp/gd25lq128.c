/**
 * @file gd25lq128.c
 * @brief GD25LQ128 external SPI NOR driver using the logical SPI bus.
 *
 * Purpose:
 ...
 *
 * Usage:
 *   Call gd25lq128_init() once after logical SPI initialization. All public
...
static bool gd25_read_id_unlocked(gd25lq128_id_t *id)
{
