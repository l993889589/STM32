...
static mcu_fdcan_context_t *bsp_fdcan_find_context(
...
bsp_status_t mcu_fdcan_abort_transmit(mcu_fdcan_context_t *context)
{
...
bsp_status_t mcu_fdcan_get_health(mcu_fdcan_context_t *context,
...
{
    mcu_fdcan_context_t *context = bsp_fdcan_find_context(handle);
