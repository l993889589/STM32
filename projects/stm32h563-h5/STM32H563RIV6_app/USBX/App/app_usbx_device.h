...
/*
 * CDC firmware BEGIN performs signed-control handling plus synchronous SPI-NOR
 * erase/blank checks in this thread.  The 2 KiB CubeMX default crosses the
 * Cortex-M33 PSPLIM guard in that call chain and lands in HardFault (STKOF).
 */
