...
/* CubeMX does not model the custom WinUSB/DPUMP interface. Keep its class
 * identifier and EP3 allocation in a protected block so regeneration cannot
 * silently remove the vendor side of the composite device. */
#define CLASS_TYPE_VENDOR                            11U
#define USBD_VENDOR_EPOUT_ADDR                       0x03U
#define USBD_VENDOR_EPIN_ADDR                        0x83U
#define USBD_VENDOR_EPOUT_FS_MPS                     64U
#define USBD_VENDOR_EPIN_FS_MPS                      64U
#define USBD_VENDOR_EPOUT_HS_MPS                     512U
#define USBD_VENDOR_EPIN_HS_MPS                      512U
