/**
 * @file ui_asset_store.h
 * @brief UI asset slot metadata, streaming descriptors, and commit API.
 *
 * External-Flash LVGL UI asset store.
 *
 * Purpose:
 *   Presents the active UI resource package in BSP_FLASH as LVGL image
