/**
 * @file app_firmware_update_service.h
 * @brief Transport-neutral begin/write/finish API for firmware updates.
 *
 * Application binding for the shared external firmware A/B transaction.
 *
 * Initialize once after BSP_FLASH startup. USB and HTTP transports then call
