...
$Hex = Join-Path $ProjectRoot "MDK-ARM\STM32H563_Bootloader\STM32H563_Bootloader.hex"
...
Write-Host "Done. The bootloader should jump to the application without an NRST wire."
exit 0
