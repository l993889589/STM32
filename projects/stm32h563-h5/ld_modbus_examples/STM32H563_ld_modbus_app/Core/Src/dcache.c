...
/**
  * @brief Enable the peripheral clock for the selected DCACHE instance.
  * @param dcacheHandle HAL DCACHE handle being initialized.
  */
...
/**
  * @brief Disable the peripheral clock for the selected DCACHE instance.
  * @param dcacheHandle HAL DCACHE handle being deinitialized.
  */
