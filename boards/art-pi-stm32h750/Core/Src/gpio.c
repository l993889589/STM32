...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, WIFI_REG_ON_Pin|LED_R_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, BT_WAKE_Pin|BT_RST_N_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LED_B_GPIO_Port, LED_B_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : BT_HOST_WAKE_Pin WIFI_HOST_WAKE_Pin KEY_Pin */
  ...
  /*Configure GPIO pins : WIFI_REG_ON_Pin LED_R_Pin */
  GPIO_InitStruct.Pin = WIFI_REG_ON_Pin|LED_R_Pin;
