...
$project = Join-Path $PSScriptRoot 'MDK-ARM\STM32H563_Modbus_ThreadX.uvprojx'
$targets = switch($Variant)
{
    'IT'  { @('STM32H563_Modbus_ThreadX_IT') }
    'DMA' { @('STM32H563_Modbus_ThreadX_DMA') }
    default { @('STM32H563_Modbus_ThreadX_IT', 'STM32H563_Modbus_ThreadX_DMA') }
}
