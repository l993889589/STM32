...
static const mcu_pwm_descriptor_t board_backlight_descriptor =
{
    .instance = TIM2,
...
static mcu_pwm_context_t board_backlight_context;

/**
 * @brief Resolve a logical PWM role to its statically owned STM32H5 context.
 */
static mcu_pwm_context_t *board_pwm_context(board_pwm_role_t role)
{
                          ...
                          bsp_pwm_result_t *result)
{
    ...
    return mcu_pwm_init(&board_backlight_context,
...
bsp_status_t bsp_pwm_configure(board_pwm_role_t role,
                               ...
                               bsp_pwm_result_t *result)
{
    mcu_pwm_context_t *context = board_pwm_context(role);
