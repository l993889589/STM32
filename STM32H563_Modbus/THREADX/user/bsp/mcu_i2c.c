 ...
 */
static bool mcu_i2c_get_limits(uint32_t bitrate_hz,
 ...
 */
static bsp_status_t mcu_i2c_validate_transfer(const mcu_i2c_context_t *context,
...
/**
 * @brief Implement mcu_i2c_init() as documented by its interface contract.
 */
...
/**
 * @brief Implement mcu_i2c_write() as documented by its interface contract.
 */
bsp_status_t mcu_i2c_write(mcu_i2c_context_t *context,
                                   ...
                                   uint32_t timeout_ms)
{
    bsp_status_t status = mcu_i2c_validate_transfer(context,
                                                    address_7bit,
                                                    data,
                                                    length,
                                                    timeout_ms);
...
/**
 * @brief Implement mcu_i2c_read() as documented by its interface contract.
 */
...
/**
 * @brief Implement mcu_i2c_memory_read() as documented by its interface contract.
 */
...
/**
 * @brief Implement mcu_i2c_memory_write() as documented by its interface contract.
 */
