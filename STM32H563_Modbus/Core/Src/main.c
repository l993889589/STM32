...
/**
 * @brief Convert an unrecoverable Cube/HAL initialization error into BSP fatal handling.
 */
...
/**
 * @brief Convert a HAL assertion into BSP fatal handling.
 */
void assert_failed(uint8_t *file, uint32_t line)
{
    (void)file;
    (void)line;
    bsp_fatal_stop(BSP_FATAL_STAGE_RUNTIME, BSP_STATUS_INVALID_ARGUMENT);
}
#endif
