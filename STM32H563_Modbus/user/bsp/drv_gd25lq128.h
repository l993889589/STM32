/**
 * @file drv_gd25lq128.h
 * @brief Bounded GD25LQ128 SPI NOR identification, read, program, and erase interface.
 */

#ifndef DRV_GD25LQ128_H
#define DRV_GD25LQ128_H

#include <stdint.h>

#include "bsp_status.h"

#define DRV_GD25LQ128_CAPACITY_BYTES (16UL * 1024UL * 1024UL)
#define DRV_GD25LQ128_PAGE_BYTES     (256UL)
#define DRV_GD25LQ128_SECTOR_BYTES   (4096UL)
