...
$project = Join-Path $PSScriptRoot 'MDK-ARM\stm32_h563_modbus.uvprojx'
...
if($root_ignore -notmatch 'STM32H563_Modbus/luoji/user/app/modbus_network_config_local\.h')
{
...
{
    $violations.Add('Keil BSP/Core grouping or compile-only HEX policy is incomplete')
}
