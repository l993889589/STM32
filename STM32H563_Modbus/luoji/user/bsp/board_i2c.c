...
static mcu_i2c_context_t board_i2c_touch_context;
                          ...
                          const bsp_i2c_config_t *config)
{
    ...
    return mcu_i2c_init(&board_i2c_touch_context,
                                I2C1,
                                kernel_clock_hz,
                                config);
}
                           ...
                           uint32_t timeout_ms)
{
    return role == BOARD_I2C_TOUCH ?
           mcu_i2c_write(&board_i2c_touch_context,
                                 address_7bit,
                                 data,
                                 length,
                                 timeout_ms) :
...
{
    return role == BOARD_I2C_TOUCH ?
           mcu_i2c_read(&board_i2c_touch_context,
                                address_7bit,
                                data,
                                length,
                                timeout_ms) :
...
{
    return role == BOARD_I2C_TOUCH ?
           mcu_i2c_memory_read(&board_i2c_touch_context,
                                       address_7bit,
                                       register_address,
                                       data,
                                       length,
...
{
    return role == BOARD_I2C_TOUCH ?
           mcu_i2c_memory_write(&board_i2c_touch_context,
                                        address_7bit,
                                        register_address,
                                        data,
                                        length,
