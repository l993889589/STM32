...
/**
 * @brief Implement mcu_pwm_init() as documented by its interface contract.
 */
...
/**
 * @brief Implement mcu_pwm_configure() as documented by its interface contract.
 */
                                       ...
                                       bsp_pwm_result_t *result)
{
    return (context == NULL) || !context->is_initialized ? BSP_STATUS_NOT_READY :
           mcu_pwm_apply(context, config, result);
}

/**
 * @brief Implement mcu_pwm_start() as documented by its interface contract.
 */
...
/**
 * @brief Implement mcu_pwm_stop() as documented by its interface contract.
 */
